...
# Как запустить?
<p><b>Скачать архив можно отсюда:</b></p>
<p><code><a>https://disk.yandex.ru/d/fN_VQMyZB_gZCA</a></code></p>
<p>Далее необходимо распаковать архив, запустить файл main.exe</p>
